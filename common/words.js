...
export const WORDS = {
  en: {
    ...
    home: {
      ...
      heroDesc:
        "I’m a <b>Full-stack Developer</b> with 1+ years of experience building dynamic, scalable, and user-friendly web and mobile apps."
    },
    ...
    experience: {
      ...
      items: {
        brightwave: {
          ...
          role: "Backend Developer · Seoul, South Korea",
          points: [
            "To‘lov tizimlari,bulutli saqlash va email/SMS xizmatlari uchun uchinchi tomon API’lari integratsiya qilish",
